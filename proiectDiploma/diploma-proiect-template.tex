...
\begin{titlepage}
{\centering\large\textbf{MULȚUMIRI}}\\
 \newline
 \newline
 \centering
 \Thanks
...
%%
\newcommand{\ProjectTitleRO}{Consistența datelor în rețele mobile colaborative ad-hoc bazate pe paradigma Drop Computing}
...
În contextul ultimilor ani folosirea dispozitivelor mobile inteligente pe o scară cât mai largă a condus la o evoluție a rețelelor mobile existente. Aceste evoluții au generat protocoale de rutare și diseminare a datelor modificate față de cele existente pentru rețelele clasice cu fir. Așadar, se introduce paradigma de Drop Computing, ce propune descentralizarea computing-ului peste rețele cu mai multe nivele, prin combinarea tehnologiilor cloud și wireless peste o mulțime socială, formată din dispozitive mobile și de margine, care va primi fiecare cerere de date sau computațională. Problema adresată în această lucrare este legată de consistența datelor primite de la vecini, putând exista situații în care datele au fost modificate intenționat sau au suferit transformări inevitabile pe traseu. Contribuțiile noastre principale includ crearea unui mecanism de rating și de așteptare al versiunilor în vederea stabilirii corectitudinii datelor recepționate. Prin simulari, arătăm că soluțiile propuse cresc gradul de consistență până la 100\% în anumite cazuri. Simularea interacțiunilor din cadrul unei astfel de rețele se bazează atât pe un model de mobilitate sintetic, cât și prin analiza unor trace-uri reale de mobilitate realizate în cadrul facultății.}
\newcommand{\AbstractEN}{In the past years, the use of smartphones and mobile devices on the widest scale has led to an evolution of existing mobile networks. These evolutions have generated different routing and dissemination algorithms compared to the existing ones for classic wired networks. Therefore, we introduced Drop Computing paradigm, which proposes the concept of decentralized computing over multilayered networks, combining cloud and wireless technologies over a social crowd formed between mobile and edge devices which will receive every data or computation request. The problem addressed in this thesis is related to the consistency of data received from the neighbors, as there may be situations where the data has been intentionally corrupted or has suffered inevitable changes on the path. Our main contributions include a rating mechanism of the nodes and a waiting mechanism for more versions of the same information in order to establish the correctness of the received data. Using simulations, we show that the proposed solutions increase the consistency level up to 100\% in some situations. The simulation of the network interactions is based both on a sintetic mobility model, as well as on two mobility traces performed at the university.}

%%
%%   Campurile aferente paginii de multumiri
%%
\newcommand{\Thanks}{
În primul rând, doresc să îi mulțumesc coordonatorului, Radu-Ioan Ciobanu, pentru sprijinul și dispoziția permanentă de a mă ajuta și îndruma în toată această perioadă. Mi-a făcut plăcere să lucrez și să fiu sub îndrumarea lui, considerând că acest lucru a contribuit decisiv la realizarea acestei lucrări.

În final, doresc să mulțumesc și să îmi exprim toată dragostea familiei mele, părinților Viorel și Petruța, care mi-au fost mereu alături și mi-au oferit tot sprijinul încă de la începutul vieții. De asemenea, doresc să mulțumesc mătușii mele, Dica, care mi-a oferit găzduire și îndrumare pe parcursul acestor 4 ani de facultate, dar și iubitei mele, Ioana, care mi-a oferit un sprijin necontenit. Nu pot să nu amintesc ocrotirea și dragostea oferită de mătușa și unchiul meu, Vali și Bebi, împreună cu verișoara mea Elena-Anda, alături de care am petrecut 4 ani deosebiți de liceu. O mulțumire specială merge către bunica mea, Stela, care mi-a fost și îmi va fi mereu un exemplu de dăruire și sacrificiu, contribuind astfel la educația și formarea mea ca om.}
\begin{document}
...
\section{Context}
Rețelele mobile și sistemul cloud sunt printre cele mai folosite resurse de comunicare din zilele noastre datorită dorinței de a accesa permanent și de pe orice dispozitiv informația. Această lucrare se bazează pe un nou concept, intitulat Drop computing, din cadrul rețelelor oportuniste. Această paradigmă oferă o alternativă pentru evitarea latențelor și costurilor ridicate ale cloud-ului prin utilizarea resurselor computaționale și a mobilității tuturor nodurilor din rețea pentru execuția și transferul cererilor unui singur nod. Fiecare nod, la rândul lui, poate primi rezolvarea unei cereri prin intermediul oricărui nod din rețea cu care intră în contact. Orice cerere computațională va purta în această lucrare denumirea de task. Astfel, un task se va propaga oportunist până la executant și apoi prin alte noduri intermediare până la proprietar. Această propagare oportunistă se referă la schimbul de task-uri realizat la întâlnirea dintre două noduri. Acest schimb este influențat de gradul de cunoaștere al nodului proprietar, de nivelul de altruism al nodului întâlnit, dar și de resurse computaționale precum baterie sau memorie. Aceste scenarii au deja rezultate deosebite în ceea ce privește gradul de utilizare al cloud-ului, procentul de reducere al costului fiind mult mai mare față de procentul cu care a scăzut performanța, acest lucru este detaliat în~\cite{DC}. Toate aceste rezultate s-au bazat pe următoarea presupunere: toate rezolvările care se interschimbă în rețea sunt corecte. Coruperea informațiilor atât în mod intenționat, cât și din cauza unor factori externi (e.g senzori defectați) determină un comportament nedorit în toate exemplele de utilizare ale acestor tipuri de rețele. Soluția propusă în această lucrare intervine în acest context de corupere, foarte plauzibil în viața reală, încercând să rezolve problema consistenței datelor.
...
$
Fiecare nod trimite în mod periodic un mesaj de tip \textit{Hello}, estimând distanța până la respectivul nod, iar pentru a estima mobilitatea unui nod se măsoară puterea semnalului dintre două mesaje \textit{Hello} succesive. În următorul pas, se estimează distanța dintre două noduri la două momente diferite de timp comparându-se cu o valoare setată ca valoare între distanța minimă și distanța maximă de transmisie dintre două noduri.\iffalse Dacă diferența estimată este aproape de 0 atunci nodurile nu se vor mișca. Dacă, în schimb, este mai mare sau egală cu valoarea de referință se începe procesul de căutare a unor noduri potrivite pentru a reține atât datele replicate de alții, cât și datele proprii din memoria nodului care a fost prezis că va parăsi zona curentă de transmisie.\fi Totodată, ținând cont de necesitățile acestor tipuri de rețele (o latență cât mai mică și o încărcare mică a rutelor de comunicație), acest algoritm este destul de costisitor și nepotrivit datorită faptului că acele mesaje periodice de Hello inundă rețeaua, dar și pentru că presupunerile de la început sugerează un comportament greu de comparat cu situațiile din viața reală, unde nu vom găsi doar noduri simetric conectate.
...
\includegraphics[width=6in]{pics/dropComputing.png}
  ...
  \label{fig:pic2}
\end{figure}
\footnotetext{Această imagine a fost preluată din articolul~\cite{DC}}
